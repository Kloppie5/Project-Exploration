...
def disassemble_x64 ( f, start, limit = -1 ) :
    ...
    #  |-> label, an identifier followed by a colon
    #           |-> mnemonic, a reserved name for a class of instruction opcodes which have the same function
    #                     |-> operands argument1, argument2, and argument3 are optional literals or identifiers
    ...
    # These operands are called immediate operands (or simply immediates).
...
0:  48 8d 64 24 d8          lea    rsp,[rsp-0x28]
8:  80 3d d1 ff ff ff 00    cmp    BYTE PTR [rip+0xffffffffffffffd1],0x0        # 0xffffffffffffffe0
11: 48 8d 05 c8 2f b3 da    lea    rax,[rip+0xffffffffdab32fc8]        # 0xffffffffdab32fe0
18: 48 8d 0d 22 00 00 00    lea    rcx,[rip+0x22]        # 0x41
1f: 48 8b 10                mov    rdx,QWORD PTR [rax]
22: 48 05 00 10 00 00       add    rax,0x1000
28: 48 39 c8                cmp    rax,rcx
2d: c6 05 ac ff ff ff 01    mov    BYTE PTR [rip+0xffffffffffffffac],0x1        # 0xffffffffffffffe0
37: 48 8d 64 24 28          lea    rsp,[rsp+0x28]
3c: e9 9f ef ff ff          jmp    0xffffffffffffefe0
    ...
    try :
        while 1 :
            ...
            if byte == b'\x5a' :
                ...
                continue
            if byte == b'\x75' :
                print(f"{50} - JNE {next(gen)}")
                continue
            if byte == b'\x7c' :
                print(f"{50} - JL {next(gen)}")
                continue
            if byte == b'\x3c' :
                print(f"{50} - JL {next(gen)} {next(gen)} {next(gen)} {next(gen)}")
                continue
...
function TDisassembler.regnrtostr(listtype: TRegisterType; nr: integer): string;
    ...
    2: 'dl'; 'dx'; 'edx'; 'rdx'; 'mm2';
    3: 'bl'; 'bx'; 'ebx'; 'rbx'; 'mm3';
    4: if rexprefix=0 then 'ah' else 'spl'; 'sp'; 'esp'; 'rsp'; 'mm4';
    5: if rexprefix=0 then 'ch' else 'bpl'; 'bp'; 'ebp'; 'rbp'; 'mm5';
    6: if rexprefix=0 then 'dh' else 'sil'; 'si'; 'esi'; 'rsi'; 'mm6';
    7: if rexprefix=0 then 'bh' else 'dil'; 'di'; 'edi'; 'rdi'; 'mm7';
    8: 'r8l'; 'r8w'; 'r8d'; 'r8'; 'mm8';
    9: 'r9l'; 'r9w'; 'r9d'; 'r9'; 'mm9';
    10: 'r10l'; 'r10w'; 'r10d'; 'r10'; 'mm10';
    11: 'r11l'; 'r11w'; 'r11d'; 'r11'; 'mm11';
    12: 'r12l'; 'r12w'; 'r12d'; 'r12'; 'mm12';
    13: 'r13l'; 'r13w'; 'r13d'; 'r13'; 'mm13';
    14: 'r14l'; 'r14w'; 'r14d'; 'r14'; 'mm14';
    15: 'r15l'; 'r15w'; 'r15d'; 'r15'; 'mm15';
